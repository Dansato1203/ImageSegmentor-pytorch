...
parser.add_argument('--weight-name', type=str, default='traced_sf_model.pt', 
...
a, img = load_image('/train/test_dataset/000317.jpg', 640, 480)
#a1 = np.expand_dims(a,axis=0)
ex = np.expand_dims(a, axis=0)
traced_script_module = torch.jit.trace(model, torch.FloatTensor(ex))
traced_script_module.save("train_result/" + args.weight-name) # これをC++から呼び出す
