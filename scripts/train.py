...
for i in range(1000):
	...
	plt.subplot(4,1,1)
	plt.plot(len(loss_list), loss_list, 'r', label='train_loss', linewidth=2)
	plt.plot(len(val_loss_list), val_loss_list, 'b', label='val_loss', linewidth=2)
	...
	plt.subplot(4,1,2)
	plt.plot(len(acc_list), loss_list, 'r', label='all_accuracy', linewidth=2)
	plt.plot(len(acc_g_list), val_loss_list, 'g', label='green_accuracy', linewidth=2)
	plt.plot(len(acc_w_list), val_loss_list, 'k', label='white_accuracy', linewidth=2)
	plt.legend(fontsize=15)
	plt.xlabel('epoch')
	plt.ylabel('accuracy')
	plt.grid(True)
	...
	plt.subplot(4,1,3)
	plt.plot(len(f_list), loss_list, 'r', label='all_f-score', linewidth=2)
	plt.plot(len(f_g_list), val_loss_list, 'b', label='green_f-score', linewidth=2)
	plt.plot(len(f_w_list), val_loss_list, 'y', label='white_f-score', linewidth=2)
	plt.legend(fontsize=15)
	plt.xlabel('epoch')
	plt.ylabel('f_score')
	plt.grid(True)
